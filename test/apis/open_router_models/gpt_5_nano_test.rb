...
class OpenRouterGPT5NanoTest < ActiveSupport::TestCase

  test "gets response from openai/gpt-5-nano model" do
    VCR.use_cassette("openrouter_gpt5_nano_basic_response") do
      ...
      assert_equal "openai/gpt-5-nano", response["model"]
  ...
  test "streams text response from openai/gpt-5-nano model" do
    VCR.use_cassette("openrouter_gpt5_nano_stream_text_response") do
      ...
      assert text_content.downcase.include?("code") || text_content.downcase.include?("programming")
  ...
  test "gets json response from openai/gpt-5-nano model" do
    VCR.use_cassette("openrouter_gpt5_nano_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "openai/gpt-5-nano",
      ...
      assert response["model"].include?("gpt-5-nano"), "Expected model to include 'gpt-5-nano'"
  ...
  test "streams json response from openai/gpt-5-nano model" do
    VCR.use_cassette("openrouter_gpt5_nano_stream_json_response") do
      # Variables to track streaming
