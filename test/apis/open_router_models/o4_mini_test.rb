...
class OpenRouterO4MiniTest < ActiveSupport::TestCase

  test "gets response from openai/o4-mini model" do
    VCR.use_cassette("openrouter_o4mini_basic_response") do
      ...
      assert model_identifier.include?("o4") || model_identifier.include?("o4-mini"),
            "Expected model identifier to include 'o4' or 'o4-mini'"
  ...
  test "streams text response from openai/o4-mini model" do
    VCR.use_cassette("openrouter_o4mini_stream_text_response") do
  ...
  test "gets json response from openai/o4-mini model" do
    VCR.use_cassette("openrouter_o4mini_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "openai/o4-mini",
      ...
      assert response["model"].include?("o4") || response["model"].include?("o4-mini"),
            "Expected model to include 'o4' or 'o4-mini'"
      ...
      assert json_data["creator"].include?("Yukihiro"),
            "Expected creator to include 'Yukihiro'"
  ...
  test "streams json response from openai/o4-mini model" do
    VCR.use_cassette("openrouter_o4mini_stream_json_response") do
      # Variables to track streaming
