...
class OpenRouterO4MiniHighTest < ActiveSupport::TestCase

  test "gets response from openai/o4-mini-high model" do
    VCR.use_cassette("openrouter_o4minihigh_basic_response") do
      ...
      assert model_identifier.include?("o4") || model_identifier.include?("o4-mini-high"),
            "Expected model identifier to include 'o4' or 'o4-mini-high'"
  ...
  test "streams text response from openai/o4-mini-high model" do
    VCR.use_cassette("openrouter_o4minihigh_stream_text_response") do
  ...
  test "gets json response from openai/o4-mini-high model" do
    VCR.use_cassette("openrouter_o4minihigh_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "openai/o4-mini-high",
      ...
      assert response["model"].include?("o4") || response["model"].include?("o4-mini-high"),
            "Expected model to include 'o4' or 'o4-mini-high'"
  ...
  test "streams json response from openai/o4-mini-high model" do
    VCR.use_cassette("openrouter_o4minihigh_stream_json_response") do
      # Variables to track streaming
