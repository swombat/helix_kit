...
class OpenRouterGPT41Test < ActiveSupport::TestCase

  test "gets response from openai/gpt-4.1 model" do
    VCR.use_cassette("openrouter_gpt41_basic_response") do
  ...
  test "streams text response from openai/gpt-4.1 model" do
    VCR.use_cassette("openrouter_gpt41_stream_text_response") do
  ...
  test "gets json response from openai/gpt-4.1 model" do
    VCR.use_cassette("openrouter_gpt41_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "openai/gpt-4.1",
  ...
  test "streams json response from openai/gpt-4.1 model" do
    VCR.use_cassette("openrouter_gpt41_stream_json_response") do
      # Variables to track streaming
