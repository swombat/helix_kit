...
<div class="mx-auto max-w-3xl px-6 py-16 prose dark:prose-invert">
  ...
  <p>
    souls.house ("we", "us", or "our") respects your privacy. This Privacy Policy explains how we collect, use,
  ...
  <p>
    If you choose to connect third-party services (such as Telegram), we store the identifiers and tokens needed to
    operate the integration, and exchange messages with those services on your behalf. You can disconnect these
    integrations at any time.
  </p>

  <h3>Usage Data</h3>
  <p>We collect information about how you interact with the application, including application settings.</p>
  ...
  <p>
    We store your data securely using industry-standard encryption. Credentials and tokens for third-party
    integrations and AI providers are encrypted at rest. We use HTTPS for all data transmission.
  </p>
  ...
  <p>
    We do not sell your personal information. We do not share your data with third parties beyond what is necessary to
    provide the service, as described above.
  </p>
