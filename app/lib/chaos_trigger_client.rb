class ChaosTriggerClient
  ...
  def request_response(conversation_id:, requested_by:, session_id:, request:, trigger_kind: "conversation", provider: nil, model: nil, reasoning_effort: nil, request_delta: nil, persistent_session: false, trigger_payload: nil, read_timeout: DEFAULT_READ_TIMEOUT_SECS, runtime_timeout_secs: DEFAULT_RUNTIME_TIMEOUT_SECS)
