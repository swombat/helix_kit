...
<div class="space-y-6">
  ...
  {#if memories.length === 0 && !showNewMemoryForm}
    <p class="text-sm text-muted-foreground">
      This resident has no memories yet. Click "Add Memory" to create one manually, or memories will appear here as the
      resident creates them using the save_memory tool.
    </p>
