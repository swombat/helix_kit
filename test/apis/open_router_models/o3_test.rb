...
class OpenRouterO3Test < ActiveSupport::TestCase

  test "gets response from openai/o3 model" do
    VCR.use_cassette("openrouter_o3_basic_response") do
      ...
      assert model_identifier.include?("o3"),
            "Expected model identifier to include 'o3'"
  ...
  test "streams text response from openai/o3 model" do
    VCR.use_cassette("openrouter_o3_stream_text_response") do
  ...
  test "gets json response from openai/o3 model" do
    VCR.use_cassette("openrouter_o3_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "openai/o3",
      ...
      assert response["model"].include?("o3"), "Expected model to include 'o3'"
      ...
      assert json_data["creator"].include?("Matsumoto"),
            "Expected creator to include 'Yukihiro Matsumoto' in #{json_data["creator"]}"
  ...
  test "streams json response from openai/o3 model" do
    VCR.use_cassette("openrouter_o3_stream_json_response") do
      # Variables to track streaming
