...
class OpenRouterGPT5ChatTest < ActiveSupport::TestCase

  test "gets response from openai/gpt-5-chat model" do
    VCR.use_cassette("openrouter_gpt5_chat_basic_response") do
      ...
      assert_equal "openai/gpt-5-chat", response["model"]
  ...
  test "streams text response from openai/gpt-5-chat model" do
    VCR.use_cassette("openrouter_gpt5_chat_stream_text_response") do
  ...
  test "gets json response from openai/gpt-5-chat model" do
    VCR.use_cassette("openrouter_gpt5_chat_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "openai/gpt-5-chat",
      ...
      assert response["model"].include?("gpt-5-chat"), "Expected model to include 'gpt-5-chat'"
  ...
  test "streams json response from openai/gpt-5-chat model" do
    VCR.use_cassette("openrouter_gpt5_chat_stream_json_response") do
      # Variables to track streaming
