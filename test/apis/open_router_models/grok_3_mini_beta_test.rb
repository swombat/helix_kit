...
class OpenRouterGrok3MiniBetaTest < ActiveSupport::TestCase

  test "gets response from x-ai/grok-3-mini-beta model" do
    VCR.use_cassette("openrouter_grok3minibeta_basic_response") do
  ...
  test "streams text response from x-ai/grok-3-mini-beta model" do
    VCR.use_cassette("openrouter_grok3minibeta_stream_text_response") do
  ...
  test "gets json response from x-ai/grok-3-mini-beta model" do
    VCR.use_cassette("openrouter_grok3minibeta_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "x-ai/grok-3-mini-beta",
  ...
  test "streams json response from x-ai/grok-3-mini-beta model" do
    VCR.use_cassette("openrouter_grok3minibeta_stream_json_response") do
      # Variables to track streaming
