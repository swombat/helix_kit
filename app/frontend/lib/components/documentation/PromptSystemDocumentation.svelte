  ...
  <div id="prompt-advanced">
    ...
    <div class="space-y-4">
      ...
      <div>
        ...
        <p class="text-sm text-muted-foreground mt-2">
          The special <code class="text-xs bg-muted px-1 rounded">"conversation"</code> template type formats messages from
          a conversation object for chat-based interactions.
        </p>
      </div>
    ...
    <div class="grid md:grid-cols-2 gap-4">
      <div class="space-y-3">
        ...
        <div>
          ...
          <p class="text-xs text-muted-foreground">Built-in exponential backoff for rate limiting and timeout errors</p>
        </div>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div>
          ...
          <p class="text-xs text-muted-foreground">Easy switching between GPT-5, Claude, and other OpenRouter models</p>
        </div>
