...
class OpenRouterGPT41MiniTest < ActiveSupport::TestCase

  test "gets response from openai/gpt-4.1-mini model" do
    VCR.use_cassette("openrouter_gpt41mini_basic_response") do
      ...
      assert model_identifier.include?("gpt-4.1") || model_identifier.include?("gpt4.1"),
            "Expected model identifier to include 'gpt-4.1' or 'gpt4.1'"
  ...
  test "streams text response from openai/gpt-4.1-mini model" do
    VCR.use_cassette("openrouter_gpt41mini_stream_text_response") do
  ...
  test "gets json response from openai/gpt-4.1-mini model" do
    VCR.use_cassette("openrouter_gpt41mini_json_response") do
      response = OpenRouterApi.new.get_response(
        params: {
          model: "openai/gpt-4.1-mini",
      ...
      assert response["model"].include?("gpt-4.1") || response["model"].include?("gpt4.1"),
            "Expected model to include 'gpt-4.1' or 'gpt4.1'"
  ...
  test "streams json response from openai/gpt-4.1-mini model" do
    VCR.use_cassette("openrouter_gpt41mini_stream_json_response") do
      # Variables to track streaming
