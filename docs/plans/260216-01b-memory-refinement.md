...
**Previous:** [260216-01a](/docs/plans/260216-01a-memory-refinement.md) | [DHH feedback](/docs/plans/260216-01a-memory-refinement-dhh-feedback.md)
...
- [ ] Rewrite `execute` with hard cap + per-op retention check
...
## Changes from 260216-01a (DHH feedback applied)
