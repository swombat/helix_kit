...
class AgentIdentityExporterTest < ActiveSupport::TestCase
  ...
  test "exports system prompt and memories without conversation transcripts" do
    ...
    refute_includes files["runtime-instructions.md"], "system prompt"
    refute_includes files["runtime-instructions.md"], "wake or trigger asks"
    ...
    assert_includes files["helixkit-api.md"], "Attach local files"
    assert_includes files["helixkit-api.md"], "helixkit-post-message \"$CHAT_ID\" --attach /tmp/ig_123.png"
    assert_includes files["helixkit-api.md"], "Chaos saves the"
    assert_includes files["helixkit-api.md"], "/tmp/<image_id>.png"
    assert_includes files["helixkit-api.md"], "$0.34"
    assert_includes files["helixkit-api.md"], "printf '%s\\n' 'The price is $4.42.'"
    assert_includes files["helixkit-api.md"], "python3 - \"$CHAT_ID\" <<'PY'"
